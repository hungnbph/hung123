...
<?php $__env->startSection('content'); ?>
    ...
    <table class="table table-dark">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo e(getClientUrl('delete-product', ['id'=>$showcate->id])); ?>" class="btn btn-sm btn-danger">Xóa</a>
                <a href="<?php echo e(getClientUrl('edit-product', ['id'=>$showcate->id])); ?>" class="btn btn-sm btn-danger">Sửa</a>
           </td>
        </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\php2\buoi10\mvc\app\views/home/danh-muc.blade.php ENDPATH**/ ?>