...
<form id="add-product-form" action="<?= getClientUrl('save-category')?>" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                ...
                <?php if(!empty($error['no_cate_name'])): ?>
                    <div class="alert alert-danger"><?php echo e($error['no_cate_name']); ?></div>
                <?php endif; ?>
                ...
                <?php if(!empty($error['no_show_menu'])): ?>
                    <div class="alert alert-danger"><?php echo e($error['no_show_menu']); ?></div>
                <?php endif; ?>
                <?php if(!empty($error['nho_hon'])): ?>
                    <div class="alert alert-danger"><?php echo e($error['nho_hon']); ?></div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\php2\buoi10\mvc\app\views/home/add-category.blade.php ENDPATH**/ ?>